...
-->
                <li>
                    <ul class="collapsible" data-collapsible="accordion">
                        <li>
                            <div class="collapsible-header"><i style="margin-right:32px;color: rgba(0,0,0,0.54);" class="material-icons">settings</i>Parámetros<i class="material-icons right">arrow_drop_down</i></div>
                            <div class="collapsible-body" style="padding-top: 0px;padding-bottom: 0px;">
                                <ul>
                                    <li><a href="{{ route('exercise.index') }}"><i class="material-icons left">fitness_center</i>Ejercicios</a></li>
                                    <li><a href="{{ route('microcycle.index') }}"><i class="material-icons left">autorenew</i>Microciclos</a></li>
                                    <li><a href="{{ route('pyramid.create') }}"><i class="material-icons left">change_history</i>Pirámides</a></li>
            ...
            <div class="footer-copyright">
                <div class="container">
                    ...
                    <span class="piereyed right">
                        Made by <a class="grey-text text-lighten-3" href="http://materializecss.com">Pier Rojas</a>
                    </span>
                </div>
            </div>
        </footer>
