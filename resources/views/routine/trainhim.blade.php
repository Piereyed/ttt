        ...
        <nav class="bread">
            <div class="nav-wrapper">
                <div class="col s12">                            
                    ...
                    <a href="{{route('hisroutines.index',$routine->person_id)}}" class="breadcrumb">Rutinas</a>
        ...
        <div class="col s12">
            ...
            <form method="post" action="{{ route('hisroutine.store') }}">
                ...
                <div class="row" style="text-align:center">
                    <div class="cos s12" >
                        <a href="{{route('hisroutines.index',$routine->person_id)}}" title="Regresar" class="btn-large waves-effect waves-teal btn-flat ">
