...
<div class="section">
        ...
        <nav class="bread">
            <div class="nav-wrapper">
                <div class="col s12">                            
                    ...
                    <a href="{{route('hisroutines.index',$session->routine->person_id)}}" class="breadcrumb">Sesiones</a>
    ...
    <div class="row" style="text-align:center">
        <div class="cos s12" >
            <a href="{{route('hisroutines.index',$session->routine->person_id)}}" title="Regresar" class="btn-large waves-effect waves-teal btn-flat ">
