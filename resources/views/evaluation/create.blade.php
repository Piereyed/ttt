            ...
            <div class="row">
                <div class="col s12">
                    <ul class="collection">
                        <li class="collection-item avatar">
                            ...
                            <span class="title">{{$client->name.' '.$client->lastname1.' '.$client->lastname2}}</span><br>
                            <span class="title">Entrenador: {{$client->trainer->name . ' ' .$client->trainer->lastname1}}</span>
                ...
                <form id="evaluar" files="true"  action="{{ route('evaluation.store',$client->id) }}" method="post" novalidate="true" class="col s12">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 offset-s0 m4 offset-m1">
                        ...
                        <!-- Objetivo -->
                        <div class="input-field col s12 offset-s0 m4 offset-m2">
...
<script>
    $("#porcentajeGrasa").on("change",function (){
        ...
        if(sexo == 'H'){
            if(icc_f > 1){
                $(".tabla-icc tbody tr").css("display","none");
            ...
            if(icc_f > 0.8){
                $(".tabla-icc tbody tr").css("display","none");
                $(".mujer.red").css("display","table-row");
            }
            else{
                $(".tabla-icc tbody tr").css("display","none");
                $(".mujer.green").css("display","table-row");
            }
        }
