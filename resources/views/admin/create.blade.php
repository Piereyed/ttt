...
<div class="section">
    ...
    <div class="row">
        <div class="col m12">
            <span class="h1">Nuevo administrador</span>
            <div class="row">
                <form id="crear_administrador" files="true" enctype="multipart/form-data" action="{{ route('admin.store') }}" method="post" novalidate="true" class="col s12">
              ...
              <div class="row">
                ...
                <div class="input-field col m6 s6">
                    ...
                    <label class="active" for="telefono">Teléfono (opcional)</label>
                </div>
            </div>
